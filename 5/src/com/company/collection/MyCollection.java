...
public class MyCollection<T> {
    ...
    public void remove(int index) {
        // Если размер списка меньше чем искомый индекс
        ...
        // Пока i не будет равен index двигаемся по списку
        // сохраняя текущую в предыдущую, а текущей приравниваем следующую
        while (i < index) {
