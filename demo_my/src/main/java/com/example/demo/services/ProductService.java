...
public class ProductService {
    ...
    private long ID = 0;
    {
        products.add(new Product(++ID,"товар 1", "описание",1000, "1"));
        products.add(new Product(++ID,"товар 2", "описание",2000, "2"));
    }
    ...
    public void editProduct(Product product, MultipartFile file1, MultipartFile file2
    ...
    public void editProduct2(Product product, MultipartFile file1, MultipartFile file2
            ,Long id) throws IOException {
